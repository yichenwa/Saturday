//========================
// Yic_Window_SavefileList.js
//========================

/*:
* @plugindesc The window for selecting a save file on the save and load screens.
* @author Yic
*
* 
* 
...
Window_SavefileList.prototype.drawContents = function(info, rect, valid) {
    ...
    if (rect.width >= 420) {
        ...
        //if (valid) {//==========================================
            ...
            //this.drawface(info, rect.x + 220, bottom - 4);
        //}
    }
...
//================
Window_SavefileList.prototype.drawface = function(info, x, y) {
    if (info.faces) {
        for (var i = 0; i < info.faces.length; i++) {
            var data = info.faces[i];
            this.drawFace(data[0], data[1], x + i * 48, y);
        }
    }
};
//================
