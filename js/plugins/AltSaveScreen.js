...
(function() {
    ...
    //=========YIC
    Window_SavefileStatus.prototype.setMapId = function(mapid) {
        this._mapid = mapid;
        this.refresh();
    };
    ...
    Window_SavefileStatus.prototype.refresh = function() {
        ...
        var mapdata = DataManager.loadMapData(mapid);//=============
        this.resetTextColor();
        if (this._mode === 'load') {
    ...
    Window_SavefileStatus.prototype.drawContents = function(info, rect, valid) {
        ...
        this.drawText(info.globalId, rect.x + 192, rect.y, rect.width - 192);
        //if (valid) {
