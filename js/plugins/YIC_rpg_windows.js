...
Window_Base._faceHeight = 144;//==============yic
...
Window_Base.prototype.drawActorSimpleStatus = function(actor, x, y, width) {
    ...
    //this.drawActorLevel(actor, x, y + lineHeight * 1);//=================YIC
...
Window_SavefileList.prototype.drawContents = function(info, rect, valid) {
    var bottom = rect.y + rect.height;
    if (rect.width >= 420) {
        this.drawGameTitle(info.title, rect.x + 192, rect.y, rect.width - 192);

        //===============================
        //YIC
        //rpg_objects.js #5407 _parallaxName
        //===============================
        //if ($gameMap.mapId()!=null) {
           // this.drawText($gameMap.mapId(), rect.x + 192+40, rect.y, rect.width - 192);
        //}
    }
    var lineHeight = this.lineHeight();
...
Window_MapName.prototype.refresh = function() {
    ...
    if ($gameMap.displayName()) {
        ...
        this.drawText($gameMap.displayName(), 0, 0, width, 'center');//========YIC
    }
};
...
Window_TitleCommand.prototype.makeCommandList = function() {
    ...
    //this.addCommand(TextManager.options,   'options');//====================YIC
};
